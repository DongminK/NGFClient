...
public class QueryStatisticsSliceFilter implements IHandler {

	@Override
	public String getName() {
		// TODO Auto-generated method stub
		return "QUERY_STATISTICS_SLICE_FILTER";
	}
	...
	public Message requestMessage() {
		...
		*/
		...
		reqMsg.setString("watch_type", "IMS_LOG");
		...
		reqMsg.setString("message_name", "IMS_LOG");
