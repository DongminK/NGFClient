...
public class IomcRemoteExecute implements IHandler {

	@Override
	public String getName() {
		// TODO Auto-generated method stub
		return "IOMC_REMOTE_EXECUTE";
	}
	...
	public Message requestMessage() {
        ...
        Message reqMsg = new Message("REMOTE_EXECUTE");
        
        reqMsg.setInteger("config_id", 5);
        reqMsg.setInteger("channel_id", 5);
